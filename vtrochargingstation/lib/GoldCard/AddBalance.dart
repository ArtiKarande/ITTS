              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //          SizedBox(width: w/30,),
                              Text('Gold card Balance', style:utils.textStyleRegular(context,42, AppTheme.text1,FontWeight.w500, 0.0,'')),
                            ],
                          ),

                          Text('₹' + currentAppState.getGoldCardAmount.toString(),
                              style:utils.textStyleRegular(context,42, double.parse(currentAppState.getGoldCardAmount) < 50 ?
                    ...
                    Padding(
                      ...
                      child: Text('Card No: ' + FlutterApp.userGoldCardNo.toString(), style:utils.textStyleRegular1(context, FontWeight.w400)),
                    ),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: w / 40),
                              Flexible(
                                child: Text('We’ll remind you to keep your card loaded.',
                              ...
                              child: NeumorphicButton(
                                onPressed: () {
                                  if(_amountController.text.isEmpty){
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => PaymentOptions(
                                        0.0, '0.0', double.parse(_amountController.text), 0.0, 'goldCard', '')));
                                ...
                                child:  Row(
                                  ...
                                  children: [
                                    ...
                                    Text('SECURE PAY',
                                        style: utils.textStyleRegular(context, 50, disabledButton == true ? AppTheme.buttonDisabled : AppTheme.text2,
                                            FontWeight.w700, 0.0, '')),
