...
class OtionDialog extends StatefulWidget {
  String msg1 = "",msg2="";

  OtionDialog({Key key, this.msg1,this.msg2}) : super(key: key);

  @override
  State<StatefulWidget> createState() => OtionDialogState();
}

class OtionDialogState extends State<OtionDialog>
                      ...
                      children: <Widget>[
                          ...
                          child: Center(
                            child: MaterialButton(
                              ...
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) => DashboardTab(4)));
                        ...
                        Container(
                          ...
                          child: new OutlineButton(
                            ...
                            child: new Text("Cancel",style: utils.textStyle(context, 50, AppTheme.BUTTON_BG_COLOR, FontWeight.normal, 0.0),),
                            onPressed: null,
